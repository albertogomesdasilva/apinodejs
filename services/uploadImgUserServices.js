...
module.exports = (multer({
    ...
    storage: multer.diskStorage({
        ...
        filename: function (req, file, cb) {
            // Criar novo nome para arquivo removendo caracteres especiais
    ...
    fileFilter: (req, file, cb) => {
        ...
        const extensionImg = [ 'application/pdf' ,'image/jpeg', 'image/jpg', 'image/png'].find((acceptedFormat) => acceptedFormat == file.mimetype);
